...
class Message extends Component {
  state = {
    validationName: this.props.data.validationName[
      this.props.data.validationName.length - 1
    ],
    validationSurname: this.props.data.validationSurname[
      this.props.data.validationSurname.length - 1
    ],
    validationLogin: this.props.data.validationLogin[
      this.props.data.validationLogin.length - 1
    ],
    validationPassword: this.props.data.validationPassword[
  ...
  render() {
    var flag = this.props.data.messageFlag[
      this.props.data.messageFlag.length - 1
    ];
    var userName = this.props.data.userName[
      this.props.data.userName.length - 1
    ];
    var userSurname = this.props.data.userSurname[
      this.props.data.userSurname.length - 1
    ];
    ...
    if (flag) {
      ...
      var city = this.props.data.validationCity[
        this.props.data.validationCity.length - 1
      ];
    }
